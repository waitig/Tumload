...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(619, 550)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Dialog.sizePolicy().hasHeightForWidth())
        Dialog.setSizePolicy(sizePolicy)
        Dialog.setMinimumSize(QtCore.QSize(619, 500))
        Dialog.setMaximumSize(QtCore.QSize(619, 600))
        font = QtGui.QFont()
        ...
        self.label_5.setGeometry(QtCore.QRect(500, 510, 101, 31))
        self.label_5.setOpenExternalLinks(True)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.label_6 = QtGui.QLabel(Dialog)
        self.label_6.setGeometry(QtCore.QRect(30, 510, 54, 31))
        self.label_6.setOpenExternalLinks(True)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.SN = QtGui.QLabel(Dialog)
        self.SN.setGeometry(QtCore.QRect(100, 520, 31, 16))
        self.SN.setObjectName(_fromUtf8("SN"))
        self.sn_line = QtGui.QLineEdit(Dialog)
        self.sn_line.setGeometry(QtCore.QRect(140, 510, 231, 31))
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(10, 450, 601, 61))
        self.groupBox_5.setObjectName(_fromUtf8("groupBox_5"))
        self.label_7 = QtGui.QLabel(self.groupBox_5)
        self.label_7.setGeometry(QtCore.QRect(60, 20, 41, 21))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.proxyHost = QtGui.QLineEdit(self.groupBox_5)
        self.proxyHost.setGeometry(QtCore.QRect(100, 20, 151, 20))
        self.proxyHost.setObjectName(_fromUtf8("proxyHost"))
        self.label_8 = QtGui.QLabel(self.groupBox_5)
        self.label_8.setGeometry(QtCore.QRect(260, 20, 31, 21))
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.proxyPort = QtGui.QLineEdit(self.groupBox_5)
        self.proxyPort.setGeometry(QtCore.QRect(290, 20, 113, 20))
        self.proxyPort.setObjectName(_fromUtf8("proxyPort"))
        self.setProxy = QtGui.QCheckBox(self.groupBox_5)
        self.setProxy.setGeometry(QtCore.QRect(440, 20, 101, 21))
        self.setProxy.setObjectName(_fromUtf8("setProxy"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "<html><head/><body><p>由于国内网速问题，请不要选择【保存视频到本地】将下载链接复制到迅雷中下载，效果最好！更多帮助请看<a href=\"http://www.waitig.com/tumload-help.html\" target=\"_blank\">在线帮助文档</a></p></body></html>", None))
        self.vipText.setText(_translate("Dialog", "<html><head/><body><p>您是<span style=\" color:#ff0000;\">【VIP用户】</span></p></body></html>", None))
        ...
        self.label_5.setText(_translate("Dialog", "<a href=\"http://www.waitig.com/\" target=\"_blank\">等英博客</a>|荣耀出品|", None))
        self.label_6.setText(_translate("Dialog", "<a href=\"http://www.waitig.com/tumload-ads.html\" target=\"_blank\">我要赞助！</a>", None))
        self.SN.setText(_translate("Dialog", "SN：", None))
        self.groupBox_5.setTitle(_translate("Dialog", "代理设置", None))
        self.label_7.setText(_translate("Dialog", "IP地址", None))
        self.proxyHost.setText(_translate("Dialog", "http://127.0.0.1", None))
        self.label_8.setText(_translate("Dialog", "端口", None))
        self.proxyPort.setText(_translate("Dialog", "1080", None))
        self.setProxy.setText(_translate("Dialog", "启用代理设置", None))
